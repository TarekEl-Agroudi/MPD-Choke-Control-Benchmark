...
function generateBenchmarkReport(Results, scenarioNames, OP, selectedWell, selectedCtrl, reportFolder, theme)
    ...
    kpi_map = containers.Map( ...
        ...
        'MaxError', 'Trapped', 'RecovOS', 'GM','PM','wcg', ...
        'wcp', 'TDM', 'S_max', 'IAW', 'IAA', 'xRT'}, ...
        {'Rise Time [s]', 'Settling Time [s]', 'Max Overshoot [bar]', 'RMSE [bar]', ...
         'Max Error [bar]', 'Pressure loss [bar]', 'Recovery Spike [bar]', 'Gain Margin [dB]', 'Phase Margin [deg]', 'Phase crossover [Hz]', ...
         'Gain crossover [Hz]', 'Time Delay Margin [s]', 'Peak Sensitivity [-]', 'Choke Vel. (IAW)', 'Choke Acc. (IAA)', 'xRT [-]'} ...
    );
